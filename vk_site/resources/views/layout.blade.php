    ...
    <nav class="fh5co-nav" role="navigation">
                ...
                <div class="row">
                    <div class="col-xs-12 text-right">
                        <ul class="fh5co-social">
                            <li><a href="/"><img src="images/vk.png" style="width: 25px;"></a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="top-menu">
            <div class="container">
                <div class="row">
                    <div class="col-xs-2">
                        <div id="fh5co-logo"><a href="/"><img src="images/vk.jpg" style=" position: absolute;left: 10px;top: 8px;">Вкдлявсех</a></div>
                    </div>
